...
boxes = [
  ...
  { :name => :drbroker, :ip => '10.110.55.70', :cpus =>1, :memory => 1024, :instance => 'm1.small' },
  { :name => :drhistory, :ip => '10.110.55.71', :cpus =>1, :memory => 1024, :instance => 'm1.small' },
  { :name => :drcoord, :ip => '10.110.55.72', :cpus =>1, :memory => 1024, :instance => 'm1.small' },
  { :name => :droverlord, :ip => '10.110.55.74', :cpus =>1, :memory => 1024, :instance => 'm1.small' },
  { :name => :drmiddle, :ip => '10.110.55.76', :cpus =>1, :memory => 1024, :instance => 'm1.small' },
